...
<body>
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <h2 class="text-white" style="height:55px; background-color:blue; padding: 10px ; ">Lista de clientes</h2>
	...
	<table  border="3">
		...
		<tbody>
			...
			<tr>
				    ...
				    <td><%=lista.get(i).getIdcadastro() %></td>  
					...
					<td><a href="select?idcadastro=<%=lista.get(i).getIdcadastro()%>" style="color:white">Editar</a>
					 <a href="delete?idcadastro=<%=lista.get(i).getIdcadastro()%>" style="color:white">Excluir</a></td>
				</tr> 
			<%} %>
		</tbody>
	</table>
